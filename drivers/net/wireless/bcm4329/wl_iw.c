...
static int wl_iw_get_country(struct net_device *dev,struct iw_request_info *info,union iwreq_data *wrqu,char *extra){
...
static int wl_iw_set_pmksa( struct net_device *dev, struct iw_request_info *info, struct iw_param *vwrq, char *extra ) {
...
//JPS				bcopy(&pmkid_list.pmkids.pmkid[i+1].BSSID,&pmkid_list.pmkids.pmkid[i].BSSID,ETHER_ADDR_LEN);
//JPS				bcopy(&pmkid_list.pmkids.pmkid[i+1].PMKID,&pmkid_list.pmkids.pmkid[i].PMKID,WPA2_PMKID_LEN);
				bcopy(&pmkid_list.pmkids.pmkid[i].BSSID,&pmkid_list.pmkids.pmkid[i-1].BSSID,ETHER_ADDR_LEN);
				bcopy(&pmkid_list.pmkids.pmkid[i].PMKID,&pmkid_list.pmkids.pmkid[i-1].PMKID,WPA2_PMKID_LEN);
			}
...
static int wl_iw_set_priv(struct net_device *dev,struct iw_request_info *info,struct iw_point *dwrq,char *ext){
	int ret = 0;
	char * extra;
