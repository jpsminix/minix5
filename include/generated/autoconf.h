...
#define CONFIG_SND_ROCKCHIP_SPDIF 1
...
#define CONFIG_MACH_RK30_BOX_HOTDOG 1
...
#define CONFIG_DEFAULT_HOSTNAME "minix"
...
#define CONFIG_GPIO_BASIC_MMIO_CORE 1
...
#define CONFIG_CMDLINE "root=LABEL=linuxroot init=/sbin/init loglevel=8 rootfstype=ext4 rootwait console=ttyFIQ0 androidboot.console=ttyFIQ0 mtdparts=rk29xxnand:0x00002000@0x00000000(parameter),0x00002000@0x00002000(misc),0x00004000@0x00004000(kernel),0x00008000@0x00008000(boot),0x00008000@0x00010000(recovery),0x000C0000@0x00018000(backup),0x00040000@0x000D8000(cache),0x00800000@0x00118000(userdata),0x00002000@0x00918000(kpanic),0x00100000@0x0091A000(system),-@0x00A3A000(user)"
...
#define CONFIG_INITRAMFS_SOURCE "initramfs_rk.cpio"
...
#define CONFIG_SND_RK_SOC_SPDIF 1
...
#define CONFIG_DDR_SDRAM_FREQ 300
